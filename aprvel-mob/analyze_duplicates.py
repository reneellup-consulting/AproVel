...
if __name__ == "__main__":
    # Path is relative to where the script is run. 
    # Assuming script is in project root and data is in data/orders.json
    target_file = os.path.join("data", "orders.json")
