...
export const HighValueCarousel = ({
  orders,
  onPress,
}: {
  ...
  // Simple state to track "active" page for dots (approximate based on scroll)
    ...
    <View style={styles.container}>
      ...
      >
        {orders.map((order, index) => {
          // Date Formatting: e.g., "11th Jun, 2025"
          ...
          return (
            ...
            >
              ...
              {/* Row 3: Details (Requester -> Purpose) */}
              <View style={styles.detailsRow}>
                <Text style={styles.detailText} numberOfLines={1}>
                  {/* Using unit_number or notes as the "Purpose/Destination" field */}
...
const makeCarouselStyles = (colors: AppColors) =>
  StyleSheet.create({
    ...
    headerTitle: {
      fontFamily: 'Inter_600SemiBold', // Bold header
      fontSize: 18,
      color: colors.foreground, // Dark Slate
    },
    badgeContainer: {
    ...
    card: {
      width: 280, // Wider card as per image
