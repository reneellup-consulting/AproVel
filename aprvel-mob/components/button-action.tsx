import { ButtonSpinner, SpinnerVariant } from '@/components/spinner-action';
...
export type ButtonSize = 'default' | 'sm' | 'lg' | 'icon' | 'action';
...
export const ButtonAction = forwardRef<View, ButtonProps>(
  (
    {
      children,
      icon,
    ...
    const rejectColor = useColor('accent');
    const approveColor = useColor('primary');
    const rejectForegroundColor = useColor('mutedForeground');
    const approveForegroundColor = useColor('primaryForeground');
    ...
    const getButtonStyle = (): ViewStyle => {
      ...
      switch (variant) {
        ...
        case 'approve':
          return { ...baseStyle, backgroundColor: approveColor };
        case 'outline':
          return {
            ...baseStyle,
    ...
    const getButtonTextStyle = (): TextStyle => {
      ...
      switch (variant) {
        case 'reject':
          return {
            ...baseTextStyle,
            color: rejectForegroundColor,
            fontSize: 14,
          };
        case 'approve':
          return {
            ...baseTextStyle,
            color: approveForegroundColor,
            fontSize: 14,
          };
        case 'outline':
