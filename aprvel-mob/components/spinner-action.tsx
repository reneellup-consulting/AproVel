...
// Types
type SpinnerSize = 'default' | 'sm' | 'lg' | 'icon' | 'action';
...
AnimatedDot.displayName = 'AnimatedDotAction';
...
AnimatedBar.displayName = 'AnimatedBarAction';
